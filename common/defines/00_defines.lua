...
NGame = {
	...
	LAG_DAYS_FOR_LOWER_SPEED = 5,					-- New Era edit; Days of client lag for decrease of gamespeed
	LAG_DAYS_FOR_PAUSE = 10,						-- New Era edit; Days of client lag for pause of gamespeed.
	...
	MESSAGE_TIMEOUT_DAYS = 30,						-- New Era edit; Useful if running the handsoff game. The popup messages that doesn't require the player respond will automatically hide after some timeout.	
